...
var finEdgarDataImportWizard = function(modelId,menuRole){
	...
	if (this.menuRole == "balanceSheetHistory") {
		this.forEdgarDataGroup = "BalanceSheetConsolidated";
		this.importFor = "EdgarBalanceSheet";
	} else if (this.menuRole == "incomeStatementHistory") {
		this.forEdgarDataGroup = "IncomeStatementConsolidated"
		this.importFor = "EdgarIncomeStatement";
	} else if (this.menuRole == "cashFlowStatementHistory") {
		this.forEdgarDataGroup = "CashFlowStatementConsolidated"
		this.importFor = "EdgarCashFlowStatement";
	} else if (this.menuRole == "valuationRatiosHistory") {
		this.forEdgarDataGroup = "ValuationRatiosMini"
		this.importFor = "EdgarValuationRatios";
	} else if (this.menuRole == "profitabilityRatiosHistory") {
		this.forEdgarDataGroup = "ProfitabilityRatiosMini"
		this.importFor = "EdgarProfitabilityRatios";
	}
    ...
    var createMappingDialog = function () {
		...
		$(dlg).dialog({
				...
				open : function (event,ui) {
					...
					Util.ajaxPost ("importEdgarFinData/edgarCols", inputObj, function(result){
...
/*    	if (json['newBlocks']){
		...
		Util.ajaxPost ("importEdgarFinData/edgarFinData", json, function(result){
    		if (!result.Status) {
    ...
    var createPreviewDialog = function () {
		...
		$(dlg).dialog({
				...
				open : function (event,ui) {
					...
					Util.ajaxPost ("importEdgarFinData/edgarFinData", importDlg.json, function(result){
						if (!result.Status) {
