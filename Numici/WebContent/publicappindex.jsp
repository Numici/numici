<!DOCTYPE html>
<html data-ng-app="vdvcPublicApp" data-ng-controller="PublicAppController">
<head>
...
<link rel="stylesheet" href="angular-libs/libs/pdfjs-dist/web/pdf_viewer.css?20210611-223753">
...
<body data-bs-breakpoint data-orientation-change data-window-resize style="background-color: #EEEEEE;" class="layout-row" data-layout="column">
...
<script type="text/javascript" src="angular-libs/underscore-min.js"></script>
...
<!-- <script type="text/javascript" src="angular-libs/angular-flash.min.js"></script> -->
...
<script type="text/javascript" src="angular-libs/libs/turndown/angular-turndown.js?20190308-154149"></script>
...
<script type="text/javascript" src="angular-libs/libs/pdfjs-dist/build/pdf.js?20210611-223753"></script>
<script type="text/javascript">
pdfjsLib.GlobalWorkerOptions.workerSrc = './angular-libs/libs/pdfjs-dist/build/pdf.worker.js?20210611-223753';
</script>
<script type="text/javascript" src="angular-libs/libs/pdfjs-dist/web/pdf_viewer.js?20210611-223753"></script>
...
<script type="text/javascript" src="apppublic/minified/uncompressed/numici-20230927-014848.js"></script>
