...
(function(){
    'use strict';
    angular.module('vdvcApp').service('uuidService', uuidService);
    uuidService.$inject = ['uuidv4'];
    function uuidService(uuidv4) {
	    var sessionUUID = uuidv4.v4();
        var service = this;
        
        service.newUuid = newUuid;
        service.getSessionUUID = function() {
			return sessionUUID;
		};
        /**
