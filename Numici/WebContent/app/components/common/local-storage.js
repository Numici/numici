 ...
 */
	...
	angular.module("vdvcApp").factory("localStorage", localStorage);
	localStorage.$inject = ['$window'];


	angular.module("vdvcApp").factory("sessionStorage", sessionStorage);
	localStorage.$inject = ['$window'];
	...
	function sessionStorage($window) {
		...
		try {
			// Test whether we can read/write sessionStorage.
