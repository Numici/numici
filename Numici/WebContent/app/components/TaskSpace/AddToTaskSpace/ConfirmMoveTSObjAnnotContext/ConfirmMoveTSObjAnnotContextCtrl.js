;(function() {
	...
	angular.module('vdvcApp').controller('ConfirmMoveTSObjAnnotContextCtrl',ConfirmMoveTSObjAnnotContextCtrl);
	
	ConfirmMoveTSObjAnnotContextCtrl.$inject = ['$scope', '$uibModal', '$uibModalInstance', 'tsObj', '_'];
			
    function ConfirmMoveTSObjAnnotContextCtrl($scope, $uibModal, $uibModalInstance, tsObj, _) {
