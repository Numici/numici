;(function() {
	...
	angular.module('vdvcApp').controller('ConfirmAddTSObjAnnotContextCtrl',ConfirmAddTSObjAnnotContextCtrl);
	
	ConfirmAddTSObjAnnotContextCtrl.$inject = ['$scope', '$uibModal', '$uibModalInstance', 'tsObj', '_'];
			
    function ConfirmAddTSObjAnnotContextCtrl($scope, $uibModal, $uibModalInstance, tsObj, _) {
