;(function(){
	...
	angular.module("vdvcApp").controller("HelpTextModalController",HelpTextModalController);
	HelpTextModalController.$inject = ['$scope','pendingRequests','topic','_','$uibModalInstance','$timeout','DeepLinkService','urlParser'];
	
	function HelpTextModalController($scope,pendingRequests,topic,_,$uibModalInstance,$timeout,DeepLinkService,urlParser){
